...
async function home() {
    ...
    for (let i = 0; i < cities.length; i++) {
        ...
        try {
            ...
            await page.goto('https://www.capreit.ca/apartments-for-rent/');
            await custom_function.sleep(2500);

            await page.waitForSelector('#input_autocomplete-1');
            await page.evaluate(() => document.querySelector('#input_autocomplete-1').value = "");
            await custom_function.sleep(400);
            await page.type("#input_autocomplete-1",location.toLowerCase());
            await custom_function.sleep(9999 * 1000);
